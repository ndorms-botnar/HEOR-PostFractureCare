...
input$prop.discharged.long.term.care.spine/sum))} else {
  rmultinorm$rmultinorm.discharged.spine.from.home.support<-rep(1,(n_microsimulation*6))
}
...
input$prop.discharged.family.home.spine/sum,
input$prop.discharged.long.term.care.spine/sum))} else {
 rmultinorm$rmultinorm.discharged.spine.from.family.home<-rep(1,(n_microsimulation*6))
}
...
input$prop.discharged.long.term.care.other/sum))} else{
  rmultinorm$rmultinorm.discharged.other.from.home.support<-rep(1,(n_microsimulation*6))
}
...
input$prop.discharged.family.home.other/sum,
input$prop.discharged.long.term.care.other/sum))} else{
  rmultinorm$rmultinorm.discharged.other.from.family.home<-rep(1,(n_microsimulation*6))
}
...
m.fun.identified<-function(df=df, t=t, rmultinorm){
...
# for male/female and no fls/ fls
m.fun.treat<-function(df=df, t=t, rmultinorm){
...
m.fun.assign.treatment<-function(df=df, t=t, rmultinorm){
...
# switching med -----
m.fun.switch.treatment<-function(df=df, t=t, rmultinorm){
if(t>14 ){
if(df[t,"intervention"]==1 &
   df[t,"sex"]==1&
...
###
# adherrence ----
m.fun.adherrence.t1<-function(df=df, t=t, rmultinorm){
...
m.fun.adherrence.t4<-function(df=df, t=t, rmultinorm){
...
m.fun.adherrence.t12<-function(df=df, t=t, rmultinorm){
...
m.fun.adherrence.t24_36_48<-function(df=df, t=t, rmultinorm){
if(df[t,"time_med"]==24|
  df[t,"time_med"]==36|
  df[t,"time_med"]==48){
...
# m.fun.adherrence<-function(df=df, t=t, rmultinorm){
#
#   # 1 - not adhering
# # 2 - adhering
#
...
# hospitalised ------
m.fun.hospitalised<-function(df=df, t=t, rmultinorm, input=input){
   #browser()
...
# procedure ------
m.fun.procedure<-function(df=df, t=t, rmultinorm, input=input){
  # 1 none
  # 2 hip surgery
  # 3 other surgery
  # 4 kyphoplasty
...
# temp rehab -----
m.fun.temp.rehab<-function(df=df, t=t, rmultinorm, input=input){
 # browser()
...
# location -----
m.fun.location<-function(df=df, t=t, rmultinorm, input=input){
